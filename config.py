...
misc_arg.add_argument(
    "--model_choose", type=str, default="RAM", help="Which model to choose: RAM, HRAM, DRAM"
)
misc_arg.add_argument(
    "--data_choose", type=str, default="MNIST", help="Which dataset to choose: MNIST, FashionMNIST, SVHN, CIFAR10"
)
misc_arg.add_argument(
...
misc_arg.add_argument(
    ...
    type=str,
    default="./plots/",
    help="Directory in which plot wil be stored",
)
misc_arg.add_argument(
    "--model_name",
    type=str,
